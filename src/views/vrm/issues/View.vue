      ...
      <div class="columns">
        ...
        <div class="column is-4">
                    ...
                    <div class="user-list-info">
                      ...
                      <div class="position">
                        ...
                        <small class="is-capitalized ml-1">
                          <RemediationRequestPriorityBadge :priority="req.priority" />
                        </small>
                        Created {{ req.created }}
                      </div>
                    </div>
          ...
          <button
            ...
            style="flex: initial"
            :disabled="
              issue.status === 'closed' || !canPerformAction('vendors', 'create')
            "
      ...
      return axios
        .get(`/remediation-request`, {
          params: {
            ...
            workspace_id: isVendor ? null : this.workspace.id,
            vendor_id: isVendor ? this.companies[0].id : null,
          },
        })
        .then((res) => {
