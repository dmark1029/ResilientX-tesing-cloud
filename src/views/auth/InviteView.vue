        ...
        <div v-if="invite" class="is-form">
          <div class="is-form-inner">
            <div class="form-text">
              ...
              <div v-if="invite?.flow === 'register'">
                <p>
                  To initialize invite process please register with email that you have
                  been invited with.
                </p>

                <router-link
                  :to="{ name: 'Register' }"
                  class="button v-button is-bold is-big is-raised is-primary button-invite"
                >
                  Register
                </router-link>
              </div>
              <div v-else>
                ...
                <div v-else-if="!user.email_verified_at">
                  <p>To initialize invite process please verify your email.</p>
                </div>
                <div v-else>
                  <p>
                    To initialize invite process please register with email that you have
                  ...
                  <button
                    class="button v-button is-bold is-big is-raised is-primary btn-block w-100 mt-3"
                    type="button"
                    @click="approveInvite"
                  >
                    Accept invitation
      ...
      return new Promise((resolve) => {
        axios
          ...
          .then((res) => {
            ...
            this.regForm.email = this.invite.email
            resolve()
          })
          .catch(() => {
    ...
    approveInvite() {
      return new Promise((resolve, reject) => {
        this.form
          ...
          .catch(() => {
            this.form.errors.set('error', this.form.errors.get('email'))
            reject()
          })
      })
    },
