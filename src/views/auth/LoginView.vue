        ...
        <div class="is-form">
          <div class="is-form-inner">
            <div class="form-text">
              ...
              <p class="account-text">Welcome back to your account.</p>
            </div>
            <form
              class="login-wrapper"
            ...
            >
              ...
              <div class="field">
                ...
                <div
                  class="password-wrapper is-flex is-justify-content-center is-align-items-center"
                >
                  <input
                    id="userpassword"
              ...
              <div class="field">
                <router-link :to="{ name: 'Forgot' }">
                  <label class="label forgot-password" for="forgotpassword">
                    Forgot Password?
                  </label>
                </router-link>
              </div>
              ...
              <div class="has-text-centered or-line">
                <div
                  class="row or-part is-flex is-justify-content-center is-align-items-center"
                >
              ...
              <div class="forgot-link has-has-text-centereded">
                <div class="footer-section">
                  <span class="footer-text">
                    ...
                    <span>
                      <RouterLink :to="{ name: 'Register' }" class="sign-up"
                        >Sign up&nbsp;</RouterLink
                      >
                    </span>
