  ...
  >
    ...
    <slot name="body">
      <template v-for="(row, index) in data" :key="index">
        <slot name="body-row-pre" :row="columns" :columns="columns" :index="index" />
        ...
        <div
          ...
          "
        >
          <slot name="body-row" :row="columns" :columns="columns" :index="index">
        ...
        <slot name="body-row-post" :row="columns" :columns="columns" :index="index" />
      </template>
    </slot>
  </div>
</template>
