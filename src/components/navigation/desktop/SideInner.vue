...
export type SideInnerTheme = 'default' | 'curved' | 'color' | 'color-curved'

const props = withDefaults(
  defineProps<{
    theme?: SideInnerTheme
    isOpen?: boolean
  }>(),
  {
    theme: 'default',
...
<template>
  <div class="sidebar-inner is-active" :class="[themeClasses]">
...
.sidebar-inner {
  ...
  .profile-dropdown {
    .dropdown-menu {
      ...
      inset-inline-start: 76% !important;
